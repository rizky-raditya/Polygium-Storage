        ...
        $("#upload").on("change", function () {
            ...
            reader.onload = function (e) {
                ...
                ipfs.add(magic_array_buffer_converted_to_buffer, (err, result) => {
                    ...
                    let ipfsLink = "<a target='_blank' href='https://dweb.link/ipfs/" + result[0].hash + "'>https://dweb.link/ipfs/" + result[0].hash +  "</a><br><a target='_blank' href='https://ipfs.infura.io/ipfs/" + result[0].hash + "'>https://ipfs.infura.io/ipfs/" + result[0].hash +  "</a><br><a target='_blank' href='https://astyanax.io/ipfs/" + result[0].hash + "'>https://astyanax.io/ipfs/" + result[0].hash +  "</a>";
